...
import { ShoppingCart, CreditCard, Tag } from 'lucide-react-native';
import {recentActivities} from '../datas.js'

export default function ListsVentes({onPress}) {
    return ( 
                                ...
                                <Pressable onPress={onPress}>
                                  <View key={item.id} style={styles.activityItem}>
                                    ...
                                    <View style={styles.row}>
                                        ...
                                        <Text style={[styles.detailText,styles.activityLocation]}>{item.buyer}</Text>
                                    </View>
                                    <View style={styles.row}>
                                    ...
                                    <View style={styles.row}>
                                        ...
                                        <Text style={[styles.detailText,styles.activitySaleId]}>{item.saleId}</Text>
                                    </View>
                                    <View style={styles.row}>
